...
public class UsuarioDAO extends BasicoDAO {
	...
	public void update (Usuario usuario) {
		String sql = " update usuario set nome_usuario = ?, email = ?, senha = ?, status = ? where cod_usuario = ?";
		...
		try (Connection conn = getConnection();
			...
			statement.setString(3, usuario.getSenha());
			statement.setInt(4, usuario.getStatus());
			statement.setInt(5, usuario.getCod_usuario());
	...
	public List<Usuario> getAll(){
		...
		String sql = " select cod_usuario, nome_usuario, email from usuario order by nome_usuario";
